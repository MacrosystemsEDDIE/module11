...
## Today's focal question: _How can we use time series models to understand and predict ecosystem conditions?_
...
Now navigate to the [Shiny app interface](https://macrosystemseddie.shinyapps.io/module11) to answer the rest of the questions.
...
\
    ...
    **Answer:**
    \
    d.  `r substr(quest["q13d", ], 4, nchar(quest["q13d", ]))`   
    \
    **Answer:**
    \
\
...
\
    ...
    **Answer:**   
    \
    d.  `r substr(quest["q27d", ], 3, nchar(quest["q27d", ]))`  
    \
    **Answer:**   
    \
\
...
\
    ...
    **Answer:**   
    \
    d.  `r substr(quest["q31d", ], 3, nchar(quest["q31d", ]))`  
    \
    **Answer:**   
    \
    e.  `r substr(quest["q31e", ], 3, nchar(quest["q31e", ]))`  
    \
    **Answer:**   
    \
\
...
46. `r substr(quest["q46", ], 6, nchar(quest["q46", ]))`  
\
**Answer:** 
\

47. `r substr(quest["q47", ], 6, nchar(quest["q47", ]))`  
\
**Answer:** 
\

This module was developed by Lofton, M.E., M.R. Hipsey, K. Kurucz, and C.C. Carey. 08 August 2025. Macrosystems EDDIE: Time Series Modeling and Prediction of Environmental Data. Macrosystems EDDIE Module 11, Version 1. https://serc.carleton.edu/eddie/teaching_materials/modules/module11.html. Module development was supported by NSF grants EF 2318861, DEB 2213550, and OISE 2330211.

This document last modified: 24 February 2026 by MEL.
